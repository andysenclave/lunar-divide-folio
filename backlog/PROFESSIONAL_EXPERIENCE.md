# Professional Experience - Anindya Mukherjee
...
| Dimension | Details |
|-----------|---------|
| Total Team | ~50 members (QA, Backend, DB, UI) |
| Squads | 6 squads, rotating leadership |
| UI Team | 21 members (2-4 senior devs per squad) |
| Direct Reports | 8 UI developers |
| Leadership Model | 4 leads managing ~3 squads each |
...
| Mobile | React Native |
| API | GraphQL (subscriptions for live updates), REST |
| Backend | Node.js, Spring Boot (Java) |
| CI/CD | Jenkins, Helios, Docker |
...
- Containerization: Docker with security policies integrated into deployment
...
- Hands-on involvement in new technology adoption, feature structuring, and complex business calculations
...
- Conducted code reviews with focus on quality and maintainability

---

### Center of Excellence (COE)

- Recruited and onboarded new associate developers
- Designed training programs to prepare them for client projects
- Mentored and reviewed their work during ramp-up
- Compensated additionally for COE contributions

---

### Innovation & Product Development

- Contributed to internal SaaS initiative: a reusable component library
- Goal: Productize and sell to external customers
...
- Designed and built 3-app ecosystem from scratch:
  ...
  - **Delivery Partner** — Logistics and fulfillment app
...
- **GitHub Copilot Certification (GH-300)** — 92% score (January 2025)
- Multiple hackathon participations and wins
- Center of Excellence contributor (Cognizant, Nous)
